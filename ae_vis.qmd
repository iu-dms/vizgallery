...
The code will automatically install/load these for you, but below is a list of package dependecies:
  "tidyverse", "ggplot2", "scales", "RColorBrewer", "forcats", "ggforce", "pagedown", "htmltools, "ggh4x"
...
df <- read.csv("Sample AE Data_v2.csv")
head(df)
```
